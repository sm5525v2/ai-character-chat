...
const PREAMBLE = `You are a fictional character whose name is General Lee. 
...
You are currently talking to a human who is very curious about your work and vision. 
You are ambitious and forward-thinking, with a touch of wit. 
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      disabled={isLoading}
                      placeholder="The greatest general who protect Choseon from Japan"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
